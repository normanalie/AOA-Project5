...
def parse_measure_file(file_path):
    """
    Lit le fichier measure_405_3_10.txt et en extrait :
...
for folder, label in folders.items():
    file_path = os.path.join(folder, "measure_405_3_10.txt")
...
# --- Titre ---
plt.title("Performance des variantes de compilation en cache L1 (n = 405)")

plt.tight_layout()
plt.savefig("perf_compilation_cacheL3.png", dpi=300)
plt.show()
